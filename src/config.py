...
class Config:
    ...
    def _override_from_env(self) -> None:
        env_mappings = {
            ...
            "BOT_RESPONSE_WHITELIST": (ConfigKeys.BOT_RESPONSE_WHITELIST, str),
            "BOT_RESPONSE_BLACKLIST": (ConfigKeys.BOT_RESPONSE_BLACKLIST, str),
            ...
            "DB_CLEAR": (ConfigKeys.DB_CLEAR, int),
    ...
    def _validate_types_and_ranges(self) -> None:
        for key, types, desc in (
            ...
            (ConfigKeys.DB_CLEAR, (int,), "database clear days"),
